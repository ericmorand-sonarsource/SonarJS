...
exports.rule = (0, s3_1.S3BucketTemplate)(
  function (bucket, context) {
    var encryptedProperty = (0, s3_1.getProperty)(context, bucket, ENCRYPTED_KEY);
    ...
    var encryptedValue = (0, helpers_1.getValueOfExpression)(
      context,
      encryptedProperty.value,
      'MemberExpression',
    );
    if (encryptedValue && isUnencrypted(encryptedValue)) {
      var propagated = (0, s3_1.findPropagatedSetting)(encryptedProperty, encryptedValue);
      context.report({
    ...
    function isUnencrypted(encrypted) {
      return (
        (0, cdk_1.normalizeFQN)((0, helpers_1.getFullyQualifiedName)(context, encrypted)) ===
