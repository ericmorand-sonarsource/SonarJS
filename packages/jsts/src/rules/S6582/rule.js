 ...
 */
var preferOptionalChainRule = typescript_eslint_1.tsEslintRules['prefer-optional-chain'];
/**
...
exports.rule = {
  meta: {
    hasSuggestions: true,
    fixable: 'code',
    messages: __assign({}, preferOptionalChainRule.meta.messages),
  },
  create: function (context) {
    var services = context.sourceCode.parserServices;
    if (
      !(services === null || services === void 0 ? void 0 : services.program) ||
