...
var OPEN_DATABASE = 'openDatabase';
exports.rule = {
  meta: {
    messages: {
  ...
  create: function (context) {
    ...
    return {
      CallExpression: function (node) {
        ...
        var symbol = (0, helpers_1.getSymbolAtLocation)(callee, services);
        if (!!symbol) {
          return;
        }
        ...
        if (
          ...
          !(0, helpers_1.isIdentifier)(callee.property, OPEN_DATABASE)
        ) {
          return;
        }
        var typeName = (0, helpers_1.getTypeAsString)(callee.object, services);
