    ...
    if ((0, helpers_1.isRequiredParserServices)(services)) {
      return {
        AwaitExpression: function (node) {
          var awaitedType = (0, helpers_1.getTypeFromTreeNode)(node.argument, services);
          if (
...
function isThenable(type) {
  var _a;
  var thenProperty = type.getProperty('then');
  return (_a =
    thenProperty === null || thenProperty === void 0 ? void 0 : thenProperty.declarations) ===
    null || _a === void 0
    ? void 0
    : _a.some(function (d) {
        return (
