...
function decorate(rule) {
  ...
  return (0, helpers_1.interceptReport)(rule, function (context, descriptor) {
    var enumMember = descriptor.node;
    var enumDecl = enumMember.parent;
...
function anyInitialized(enumDecl) {
  return enumDecl.members.some(function (m) {
    return m.initializer !== undefined;
  });
}
function numericalOrder(enumDecl) {
  var _a;
  var firstMember = enumDecl.members[0];
  var membersRest = enumDecl.members.slice(1);
  return (
    ((_a = firstMember.initializer) === null || _a === void 0 ? void 0 : _a.type) === 'Literal' &&
    (0, helpers_1.isNumberLiteral)(firstMember.initializer) &&
    membersRest.every(function (m) {
      return m.initializer === undefined;
    })
  );
}
