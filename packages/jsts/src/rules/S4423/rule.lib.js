...
var SECURE_PROTOCOL_ALLOWED_VALUES = [
  'TLSv1_2_method',
...
exports.rule = {
  ...
  create: function (context) {
    function getValueOfProperty(objectExpression, propertyName) {
      var unsafeProperty = (0, helpers_1.getObjectExpressionProperty)(
        objectExpression,
        propertyName,
      );
      if (unsafeProperty) {
    ...
    function checkSslOptions(optionsNode) {
      var _a, _b;
      var options = (0, helpers_1.getValueOfExpression)(context, optionsNode, 'ObjectExpression');
      var minVersion = getValueOfProperty(options, 'minVersion');
      var maxVersion = getValueOfProperty(options, 'maxVersion');
      checkMinMaxVersion('minVersion', minVersion);
      checkMinMaxVersion('maxVersion', maxVersion);
      var secureProtocol = getValueOfProperty(options, 'secureProtocol');
      var secureProtocolValue =
        (_b =
          (_a =
            secureProtocol === null || secureProtocol === void 0
              ? void 0
              : secureProtocol.value) === null || _a === void 0
            ? void 0
      ...
      var secureOptions = (0, helpers_1.getObjectExpressionProperty)(options, 'secureOptions');
