...
exports.rule = (0, cdk_1.AwsCdkTemplate)(
  {
    'aws_cdk_lib.aws_apigateway.CfnDomainName': (0, cdk_1.AwsCdkCheckArguments)(
      'AWSApiGateway',
      true,
      'securityPolicy',
      { primitives: { valid: ['TLS_1_2'] } },
    ),
    'aws_cdk_lib.aws_apigateway.DomainName': (0, cdk_1.AwsCdkCheckArguments)(
      'AWSApiGateway',
      false,
      'securityPolicy',
      { fqns: { valid: ['aws_cdk_lib.aws_apigateway.SecurityPolicy.TLS_1_2'] } },
    ),
    'aws_cdk_lib.aws_elasticsearch.CfnDomain': (0, cdk_1.AwsCdkCheckArguments)(
    ...
    'aws_cdk_lib.aws_opensearchservice.Domain': (0, cdk_1.AwsCdkCheckArguments)(
      ['AWSOpenElasticSearch', 'enforceTLS12'],
      true,
      'tlsSecurityPolicy',
      {
    ...
    'aws_cdk_lib.aws_opensearchservice.CfnDomain': (0, cdk_1.AwsCdkCheckArguments)(
      ['AWSOpenElasticSearch', 'enforceTLS12'],
      true,
      ['domainEndpointOptions', 'tlsSecurityPolicy'],
      {
    ...
    'aws_cdk_lib.aws_elasticsearch.Domain': (0, cdk_1.AwsCdkCheckArguments)(
      ['AWSOpenElasticSearch', 'enforceTLS12'],
      true,
      'tlsSecurityPolicy',
      {
