...
var reaching_definitions_1 = require('../reaching-definitions');
var ast_1 = require('../ast');
function getFlags(callExpr, context) {
  if (callExpr.arguments.length < 2) {
    return '';
  }
  var flags = callExpr.arguments[1];
  ...
  if (flags.type === 'Identifier' && context !== undefined) {
    ...
    var variable = (0, reaching_definitions_1.getVariableFromIdentifier)(flags, context.getScope());
    var ref = (0, ast_1.getUniqueWriteReference)(variable);
