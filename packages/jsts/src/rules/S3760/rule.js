...
var MESSAGE = 'Convert this operand into a number.';
exports.rule = {
  meta: {
    schema: [
      {
  ...
  create: function (context) {
    ...
    return {
      BinaryExpression: function (node) {
        ...
        var leftType = (0, helpers_1.getTypeFromTreeNode)(binaryExpression.left, services);
        var rightType = (0, helpers_1.getTypeFromTreeNode)(binaryExpression.right, services);
        if (operator === '+') {
      ...
      AssignmentExpression: function (node) {
        ...
        var leftType = (0, helpers_1.getTypeFromTreeNode)(assignmentExpression.left, services);
        var rightType = (0, helpers_1.getTypeFromTreeNode)(assignmentExpression.right, services);
        if (operator === '+=') {
      ...
      'UnaryExpression[operator="-"]': function (node) {
        var unaryExpression = node;
        var type = (0, helpers_1.getTypeFromTreeNode)(unaryExpression.argument, services);
      ...
      UpdateExpression: function (node) {
        ...
        var type = (0, helpers_1.getTypeFromTreeNode)(updateExpression.argument, services);
        if (isBooleanStringOrDate(type)) {
          context.report({
...
function isDateMinusDateException(leftType, rightType, operator) {
  ...
  if (
    ((_a = leftType.symbol) === null || _a === void 0 ? void 0 : _a.name) === 'Date' &&
    (((_b = rightType.symbol) === null || _b === void 0 ? void 0 : _b.name) === 'Date' ||
      (rightType.flags & typescript_1.default.TypeFlags.Any) > 0)
  ) {
    return true;
  }
  if (
    ((_c = rightType.symbol) === null || _c === void 0 ? void 0 : _c.name) === 'Date' &&
    (leftType.flags & typescript_1.default.TypeFlags.Any) > 0
  ) {
    return true;
  }
  return false;
...
function isBoolean(type) {
  ...
  return (
    ...
    ((_a = type.symbol) === null || _a === void 0 ? void 0 : _a.name) === 'Boolean'
  );
}
function isNumber(type) {
  ...
  return (
    ...
    ((_a = type.symbol) === null || _a === void 0 ? void 0 : _a.name) === 'Number'
  );
}
function isBooleanStringOrDate(type) {
  ...
  return (
    ...
    ((_a = type.symbol) === null || _a === void 0 ? void 0 : _a.name) === 'Date'
  );
}
