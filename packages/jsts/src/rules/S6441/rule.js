...
var noUnusedClassComponentMethod = eslint_plugin_react_1.rules['no-unused-class-component-methods'];
...
exports.rule = {
  ...
  create: function (context) {
    var isReact = false;
    var detectReactListener = helpers_1.rule.create(
      overrideContext(context, {
        report: function (_descriptor) {
          isReact = true;
        },
      }),
    );
    var noUnusedClassComponentMethodListener = noUnusedClassComponentMethod.create(
      overrideContext(context, {
