...
var ENFORCE_SSL_KEY = 'enforceSSL';
var messages = {
...
exports.rule = (0, s3_1.S3BucketTemplate)(function (bucket, context) {
  var enforceSSLProperty = (0, s3_1.getProperty)(context, bucket, ENFORCE_SSL_KEY);
  ...
  var enforceSSLValue = (0, helpers_1.getValueOfExpression)(
    context,
    enforceSSLProperty.value,
    'Literal',
  );
  if (
    (enforceSSLValue === null || enforceSSLValue === void 0 ? void 0 : enforceSSLValue.value) ===
    false
  ) {
    context.report({
