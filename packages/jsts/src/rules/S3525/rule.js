...
exports.rule = {
  ...
  create: function (context) {
    ...
    var isFunction = (0, helpers_1.isRequiredParserServices)(services)
      ? isFunctionType
      : isFunctionLike;
    return {
      AssignmentExpression: function (node) {
        ...
        if (left.type === 'MemberExpression' && isFunction(right, services)) {
          var _b = [left.object, left.property],
            member = _b[0],
            prototype = _b[1];
          if (member.type === 'MemberExpression' && prototype.type === 'Identifier') {
            var _c = [member.object, member.property],
              klass = _c[0],
              property = _c[1];
            if (
...
function isFunctionType(node, services) {
  var type = (0, helpers_1.getTypeFromTreeNode)(node, services);
