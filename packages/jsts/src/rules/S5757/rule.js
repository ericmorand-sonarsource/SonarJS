...
var MESSAGE = 'Make sure confidential information is not logged here.';
exports.rule = {
  meta: {
    schema: [
      {
  ...
  create: function (context) {
    return {
      NewExpression: function (node) {
        ...
        var callee = newExpression.callee;
        ...
        var firstArgument = (0, helpers_1.getValueOfExpression)(
          context,
        ...
        var secrets = (0, helpers_1.getObjectExpressionProperty)(firstArgument, 'secrets');
        if (
          secrets &&
