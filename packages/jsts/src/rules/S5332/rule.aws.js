...
var sensitivePorts = [80, 8080, 8000, 8008];
exports.rule = (0, cdk_1.AwsCdkTemplate)(
  {
    'aws-cdk-lib.aws_elasticache.CfnReplicationGroup': (0, cdk_1.AwsCdkCheckArguments)(
      'replicationGroup',
      true,
      'transitEncryptionEnabled',
      { primitives: { invalid: [false] } },
    ),
    'aws-cdk-lib.aws_kinesis.Stream': (0, cdk_1.AwsCdkCheckArguments)(
      'streamEncryptionDisabled',
      false,
      'encryption',
      { fqns: { invalid: ['aws_cdk_lib.aws_kinesis.StreamEncryption.UNENCRYPTED'] } },
    ),
    'aws-cdk-lib.aws_kinesis.CfnStream': (0, cdk_1.AwsCdkCheckArguments)(
      'streamEncryptionDisabled',
      true,
      'streamEncryption',
    ),
    'aws-cdk-lib.aws_elasticloadbalancing.LoadBalancer': {
      callExpression: (0, cdk_1.AwsCdkCheckArguments)(
        'noSSLTLS',
        false,
        'externalProtocol',
        {
      ...
      newExpression: (0, cdk_1.AwsCdkCheckArguments)(
        'noSSLTLS',
        false,
        ['listeners', 'externalProtocol'],
        {
          fqns: {
            invalid: [
              'aws-cdk-lib.aws_elasticloadbalancing.LoadBalancingProtocol.TCP',
    ...
    'aws-cdk-lib.aws_elasticloadbalancing.CfnLoadBalancer': (0, cdk_1.AwsCdkCheckArguments)(
      'noSSLTLS',
      false,
      ['listeners', 'protocol'],
    ...
    'aws-cdk-lib.aws_elasticloadbalancingv2.NetworkLoadBalancer': {
      callExpression: function (expr, ctx) {
        var httpProtocol = (0, cdk_1.AwsCdkCheckArguments)(
          'noSSLTLS',
          false,
          'protocol',
          {
        ...
        var node = httpProtocol(expr, ctx);
        if (node) {
          ctx.report({ messageId: 'noSSLTLS', node: node });
        } else {
          var missingProtocol = (0, cdk_1.AwsCdkCheckArguments)(
            'noSSLTLS',
            true,
            'protocol',
            undefined,
          ...
          if (missingProtocol(expr, ctx)) {
            var certificatesChecker = (0, cdk_1.AwsCdkCheckArguments)(
              'noSSLTLS',
              true,
              'certificates',
              undefined,
            ...
            var portNode = certificatesChecker(expr, ctx);
            if (portNode) {
    ...
    'aws-cdk-lib.aws_elasticloadbalancingv2.NetworkListener': function (expr, ctx) {
      var httpProtocol = (0, cdk_1.AwsCdkCheckArguments)(
        'noSSLTLS',
        false,
        'protocol',
    ...
    'aws-cdk-lib.aws_elasticloadbalancingv2.CfnListener': (0, cdk_1.AwsCdkCheckArguments)(
      'noSSLTLS',
      false,
      'protocol',
...
function httpOrSensitivePort(position) {
  return function (expr, ctx) {
    ...
    if (node) {
      ...
      if (missingProtocol(expr, ctx)) {
        var portChecker = (0, cdk_1.AwsCdkCheckArguments)(
          'noSSLTLS',
          false,
          'port',
        ...
        var portNode = portChecker(expr, ctx);
        if (portNode) {
          ctx.report({ messageId: 'noSSLTLS', node: portNode });
        }
      }
