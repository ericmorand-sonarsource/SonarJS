...
var UNIX_DIRECTORIES = [
  ...
  return new RegExp('^'.concat(v), 'i');
});
var WINDOWS_DIRECTORIES_PATTERN = new RegExp(
  '^[^\\\\]*(\\\\){1,2}(Windows(\\\\){1,2}Temp|Temp|TMP)(\\\\.*|$)',
  'i',
);
var SENSITIVE_ENV_VARIABLES = ['TMPDIR', 'TMP', 'TEMPDIR', 'TEMP'];
exports.rule = {
  meta: {
    messages: {
  ...
  create: function (context) {
    return {
      Literal: function (node) {
        ...
        var value =
          (_a = literal.raw) === null || _a === void 0
            ? void 0
            : _a.slice(1, literal.raw.length - 1);
        if (
          value &&
          (UNIX_DIRECTORIES.find(function (i) {
            return value.match(i);
          }) ||
            value.match(WINDOWS_DIRECTORIES_PATTERN))
        ) {
          context.report({
            node: literal,
