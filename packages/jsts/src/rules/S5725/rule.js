...
exports.rule = {
  ...
  create: function (context) {
    ...
    function shouldReport(assignedVariable) {
      var nbSrcAssignment = 0;
      var hasUnsafeSrcAssignment = false;
      var hasIntegrityAssignment = false;
      assignedVariable.references.forEach(function (ref) {
        var parentNode = ref.identifier.parent;
        if (!parentNode) {
          return;
        }
    ...
    function isSrcAssignment(memberExpression) {
      ...
      var assignmentExpression = memberExpression.parent;
      if (
        (assignmentExpression === null || assignmentExpression === void 0
          ? void 0
    ...
    function isUnsafeSrcAssignment(memberExpression) {
      ...
      var right = memberExpression.parent.right;
    ...
    return {
      'VariableDeclarator[init.type="CallExpression"]': function (node) {
        var variableDeclarator = node;
        var callExpression = variableDeclarator.init;
        var left = variableDeclarator.id;
        ...
        var typeName = (0, helpers_1.getTypeAsString)(left, services);
        if (
          !(0, helpers_1.isIdentifier)(callee.object, 'document') ||
        ...
        var assignedVariable = scope.variables.find(function (v) {
          return v.name === left.name;
        });
        if (!assignedVariable) {
          return;
        }
