...
exports.rule = {
  ...
  create: function (context) {
    var patterns = [/CBC/i, /ECB/i];
    aliases.forEach(function (alias) {
      return patterns.push(new RegExp('^'.concat(alias, '$'), 'i'));
    });
    return {
      CallExpression: function (node) {
        ...
        var sensitiveArgument = callExpression.arguments[0];
        var sensitiveArgumentValue = (0, helpers_1.getValueOfExpression)(
          context,
          sensitiveArgument,
          'Literal',
        );
        ...
        var value = sensitiveArgumentValue.value;
