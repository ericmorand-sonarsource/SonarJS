 ...
 */
var babelESLintParser = __importStar(require('@babel/eslint-parser'));
var vueESLintParser = __importStar(require('vue-eslint-parser'));
var typescriptESLintParser = __importStar(require('@typescript-eslint/parser'));
/**
