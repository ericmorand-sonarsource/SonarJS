...
exports.TypeScriptRuleTester = void 0;
/*
...
var placeHolderFilePath = path.resolve(''.concat(__dirname, '/fixtures/placeholder.tsx'));
/**
 ...
 */
var TypeScriptRuleTester = /** @class */ (function (_super) {
  __extends(TypeScriptRuleTester, _super);
  function TypeScriptRuleTester() {
    return (
      _super.call(this, {
        env: env,
        parser: parser,
  ...
  TypeScriptRuleTester.prototype.run = function (name, rule, tests) {
  ...
  return TypeScriptRuleTester;
})(eslint_1.RuleTester);
exports.TypeScriptRuleTester = TypeScriptRuleTester;
