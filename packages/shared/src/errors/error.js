...
var APIError = /** @class */ (function (_super) {
  ...
  function APIError(code, message, data) {
    var _this = _super.call(this, (0, helpers_1.unicodeEscape)(message)) || this;
    _this.code = code;
    _this.data = data;
    return _this;
  }
